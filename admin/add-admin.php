...
<body class="admin-layout">
    ...
    <header class="mobile-header">
        ...
        <span class="mobile-page-title">Añadir Admin</span>
    ...
    <main class="admin-main">
        <div class="tab-header">
            <div>
                <h1>Añadir Admin</h1>
                <p class="tab-subtitle">Nuevo administrador del sistema</p>
            </div>
        ...
        <div class="content-card admin-form-card">
            <form action="add-admin.php" method="POST" class="admin-form">
                ...
                <div class="admin-form-field">
                    ...
                    <input type="email" id="email" name="email" placeholder="Ej. juan@kavana.com" required>
                </div>
                <div class="admin-form-field">
